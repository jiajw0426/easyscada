...
# ADD LINK32 advapi32.lib user32.lib snmpapi.lib utilities.lib wsock32.lib qt-mt3.lib dbase.lib /nologo /subsystem:console /pdb:"Release/dspserver.pdb" /debug /machine:I386 /libpath:"$(QTDIR)\lib" /libpath:"c:\scada\lib"
...
# ADD LINK32 advapi32.lib user32.lib snmpapi.lib utilitiesd.lib dbased.lib wsock32.lib qt-mt3.lib /nologo /subsystem:console /incremental:no /pdb:"Debug/dspserver.pdb" /debug /machine:I386 /pdbtype:sept /libpath:"$(QTDIR)\lib" /libpath:"c:\scada\lib"
# SUBTRACT LINK32 /pdb:none
