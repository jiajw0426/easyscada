...
static const char * iniFind(void * fp, /* already opened file ptr */
                            const char * tag, /* string to find */
                            const char * section); /* section it's in */

static int iniSection(void * fp, /* already opened file ptr */
...
int Inifile::section(const char *section,
                     INIFILE_ENTRY array[],
                     int max)
{
...
static const char *iniFind(void *fp, const char *tag, const char *section)
{
  static char line[INIFILE_MAX_LINELEN+2]; /* 1 for newline, 1 for NULL */
  static char bracketsection[INIFILE_MAX_LINELEN+2];
  char *nonwhite;
