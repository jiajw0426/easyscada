...
static QString applicationName = QString("IndigoSCADA Protocol Configurator");
static QString applicationIconName = QString("icone16.png");
static QString aboutText = QString("Version 1.0\n\nUsed to create, design and edit database protocol configuration files compatible with SQLite 3.x.\n\n");
