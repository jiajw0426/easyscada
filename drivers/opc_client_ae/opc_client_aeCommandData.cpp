...
File: Opc_client_aeCommandData.cpp
...
Opc_client_aeCommandData::Opc_client_aeCommandData(QWidget *parent, const char *name)
...
Opc_client_aeCommandData::~Opc_client_aeCommandData()
{
}
