...
#define Inherited Opc_client_aeInputData

Opc_client_aeInput::Opc_client_aeInput
(
QWidget* parent,
const char* name
)
...
void Opc_client_aeInput::Load(const QString &s)// load the configuration
{
	/*
...
void Opc_client_aeInput::Save(const QString &s)// save the configuration
{
	//
