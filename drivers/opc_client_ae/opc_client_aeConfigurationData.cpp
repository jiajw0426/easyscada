...
File: Opc_client_aeConfigurationData.cpp
...
Opc_client_aeConfigurationData::Opc_client_aeConfigurationData(QWidget *parent, const char *name)
...
Opc_client_aeConfigurationData::~Opc_client_aeConfigurationData()
{
}
