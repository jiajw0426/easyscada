...
File: Iec103driverCommand.cpp
Last generated: Mon May 22 17:14:04 2000
*********************************************************************/
#include "Iec103driverCommand.h"
#include <qt.h>
#include "Iec103driver.h"
#define Inherited Iec103driverCommandData
Iec103driverCommand::Iec103driverCommand
(
QWidget* parent,
const char* name,
...
{
	setCaption(tr("Iec103driver Command"));
...
void Iec103driverCommand::Help()
{
	//
	// invoke the help viewer for the Iec103driver
	// 
	QSHelp("Iec103driver_command");
}

void Iec103driverCommand::OkClicked()
{
...
void Iec103driverCommand::QueryResponse (QObject *p, const QString &c, int id, QObject*caller) // handles database responses
{
	if(p != this) return;
	switch(id)
	{
