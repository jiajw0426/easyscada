...
*Returns:none
*/
void Iec103driver_Instance::Stop() // stop everything under this driver's control
{	
	IT_IT("Iec103driver_Instance::Stop");
...
*/
//Realtime method
void Iec103driver_Instance::driverEvent(DriverEvent *p)
{
	IT_IT("Iec103driver_Instance::driverEvent");
...
//Realtime method
bool Iec103driver_Instance::expect(unsigned int cmd)
{
	IT_IT("Iec103driver_Instance::expect");
...
//Realtime method
void Iec103driver_Instance::removeTransaction()
{
	IT_IT("Iec103driver_Instance::removeTransaction");
...
void Iec103driver_Instance::Tick()
{
	IT_IT("Iec103driver_Instance::Tick");
...
//Realtime method
bool Iec103driver_Instance::event(QEvent *e)
{
	IT_IT("Iec103driver_Instance::event");
...
bool Iec103driver_Instance::Connect() 
{	
	IT_IT("Iec103driver_Instance::Connect");
	//return 0 on fail
	//return 1 on success

	if(pConnect) delete pConnect;
	
	pConnect = new Iec103DriverThread(this); // create the connection
...
*Returns:none
*/
bool  Iec103driver_Instance::Disconnect()        
{
	IT_IT("Iec103driver_Instance::Disconnect");
...
*/
//Realtime method
bool  Iec103driver_Instance::DoExec(SendRecePacket *t)
{
	IT_IT("Iec103driver_Instance::DoExec");
...
*Returns:none
*/
void Iec103driver_Instance::Command(const QString & name, BYTE cmd, LPVOID lpPa, DWORD pa_length, DWORD ipindex) // process a command for a named unit 
{
	IT_IT("Iec103driver_Instance::Command");
