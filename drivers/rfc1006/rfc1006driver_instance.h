...
#ifndef RFC1006DRIVER__INSTANCE
#define RFC1006DRIVER__INSTANCE
...
class RFC1006DRIVERDRV Rfc1006driver_Instance : public DriverInstance 
{
	Q_OBJECT
	//
	//
...
//	QStringList SampleList; // list of sample points
    ...
    pConnect(NULL)
	{
		IT_IT("Rfc1006driver_Instance::Rfc1006driver_Instance");
