 ...
 *
 */
#ifndef IEC101_DRIVERTHREAD
#define IEC101_DRIVERTHREAD
...
class IEC_101_DRIVERDRV Iec101DriverThread : public DriverThread 
{
	public:
	...
	Iec101DriverThread(DriverInstance *parent) : 
		DriverThread(parent),h_pipe(NULL), nIndex(1), pipe_sends_cont(0),
        msg_id(0), Done(false), restart_count(0)
	{ 
		IT_IT("Iec101DriverThread::Iec101DriverThread");

		instanceID = ((Iec101driver_Instance*)Parent)->instanceID;
