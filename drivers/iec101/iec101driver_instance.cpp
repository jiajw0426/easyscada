...
*Returns:none
*/
void Iec101driver_Instance::Stop() // stop everything under this driver's control
{	
	IT_IT("Iec101driver_Instance::Stop");
...
*Returns:none
*/
void Iec101driver_Instance::QueryResponse(QObject *p, const QString &c, int id, QObject*caller) // handles database responses
{
	IT_IT("Iec101driver_Instance::QueryResponse");
...
//						Values[k].fSpotValue = a.toInt(); 
		...
		case tUnitProperties:
		{
			if(GetConfigureDb()->GetNumberResults() > 0)
			{
				...
				//Start IEC 101 master driver
				if(!Connect())
				{
					QSLogAlarm(Name,tr("Failed to start IEC 101 client driver"));
				}
			}
		}
		break;
...
*/
//Realtime method
void Iec101driver_Instance::driverEvent(DriverEvent *p)
{
	IT_IT("Iec101driver_Instance::driverEvent");
...
//Realtime method
bool Iec101driver_Instance::expect(unsigned int cmd)
{
	IT_IT("Iec101driver_Instance::expect");
...
//Realtime method
void Iec101driver_Instance::removeTransaction()
{
	IT_IT("Iec101driver_Instance::removeTransaction");
...
void Iec101driver_Instance::Tick()
{
	IT_IT("Iec101driver_Instance::Tick");
...
//Realtime method
bool Iec101driver_Instance::event(QEvent *e)
{
	IT_IT("Iec101driver_Instance::event");
...
#ifdef WIN32
	strcat(log_file, "\\logs\\iec101.log");
#elif __unix__
	strcat(log_file, "/logs/iec101.log");	
#endif
...
bool Iec101driver_Instance::Connect() 
{	
	IT_IT("Iec101driver_Instance::Connect");
	//return 0 on fail
	//return 1 on success

	if(pConnect) delete pConnect;
	
	pConnect = new Iec101DriverThread(this); // create the connection
...
*Returns:none
*/
bool  Iec101driver_Instance::Disconnect()        
{
	IT_IT("Iec101driver_Instance::Disconnect");
...
*/
//Realtime method
bool  Iec101driver_Instance::DoExec(SendRecePacket *t)
{
	IT_IT("Iec101driver_Instance::DoExec");
...
*Returns:none
*/
void Iec101driver_Instance::Command(const QString & name, BYTE cmd, LPVOID lpPa, DWORD pa_length, DWORD ipindex) // process a command for a named unit 
{
	IT_IT("Iec101driver_Instance::Command");
