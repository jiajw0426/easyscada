...
/*
*Opc_client_hda driver (OPC Alarms and Events 1.10)
*
*/
...
/*
*Function:Opc_client_hda
*Inputs:none
*Outputs:none
*Returns:none
*/
Opc_client_hda::Opc_client_hda(QObject *parent,const QString &name) : Driver(parent,name),n_opc_items(0)
{
...
*Returns:none
*/
void Opc_client_hda::UnitConfigure(QWidget *parent, const QString &name, const QString &receipe) // configure a unit
{
	Opc_client_hdaConfiguration dlg(parent,name,receipe);
	dlg.exec();   
};
/*
*Function:UnitConfigure
...
*Returns:none
*/
void Opc_client_hda::CommandDlg(QWidget *parent, const QString &name) // command dialog
{
	Opc_client_hdaCommand dlg(parent,name);
	dlg.exec();   
};
/*
...
*Returns:none
*/
void Opc_client_hda::Command(const QString & instance,BYTE cmd, LPVOID lpPa, DWORD pa_length, DWORD ipindex)
{
	IT_IT("Opc_client_hda::Command");
...
*Returns:none
*/
void Opc_client_hda::CreateNewUnit(QWidget *parent, const QString &name, int n_inputs) // create a new unit - quick configure
{
...
//
Opc_client_hda * Opc_client_hda::pDriver = 0; // only one instance should be created
/*
*Function: Start
*Inputs:none
*Outputs:none
...
*Returns:none
*/
void Opc_client_hda::Stop() // stop everything under this driver's control
{
...
*Returns:none
*/
void Opc_client_hda::QueryResponse (QObject *p, const QString &, int id, QObject*caller)
{
	if(this != p) return;
	switch(id)
	{  
		case tListUnits:
		{
			...
			if(n > 0)
			{
				for(int i = 0; i < n; i++,GetConfigureDb()->FetchNext())
				{
					...
					Opc_client_hda_Instance *p = new Opc_client_hda_Instance(this, unit_name, i);
...
{ 
	...
	{
		if(!Opc_client_hda::pDriver)
		{
			Opc_client_hda::pDriver = new Opc_client_hda(parent,"Opc_client_hda");
		};
		return Opc_client_hda::pDriver;
	};
	/*
	*Function: _Unload
	...
	*/
	void _cdecl _Unload()
	{
		if(Opc_client_hda::pDriver) delete Opc_client_hda::pDriver;
		Opc_client_hda::pDriver = 0;
	};
};
