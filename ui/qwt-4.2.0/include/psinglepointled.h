...
#ifndef PSINGLEPOINTLED_H
#define PSINGLEPOINTLED_H
...
/*!
  ...
  The LED widget imitates look and behaviour of a Single POint LED.

  \image html led_rg0001.png
*/

class QWT_EXPORT PSinglePointLed: public QWidget
{
    Q_OBJECT
...
public:
    PSinglePointLed(QWidget *parent=0,const char *name=0);
