...
#ifndef PTHERMOMETER_H
#define  PTHERMOMETER_H
...
/*!
  \brief The Thermometer Widget plugin.

  \image html PThermometer.png
*/
class QWT_EXPORT PThermometer : public QWidget
{
    Q_OBJECT
    Q_ENUMS( BorderStyle )
...
public:
    ...
    */
    ...
    PThermometer(QWidget *parent=0,const char *name=0);
    /*!
...
protected:
    ...
    void drawThermometer(QPainter *painter);
