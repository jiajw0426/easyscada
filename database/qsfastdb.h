...
#ifndef include_qsfastdb_h 
#define include_qsfastdb_h 
#include "common.h"
#include "dbase.h"
...
class QSFastdb  : public QSDatabase
{
	...
	//
	public:
	QSFastdb() : pConnect(NULL),currentRecord(0)
	{
		IT_IT("QSFastdb::QSFastdb()");
