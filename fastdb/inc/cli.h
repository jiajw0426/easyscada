...
//namespace fastdb { //BEGIN_FASTDB_NAMESPACE
...
int FASTDB_DLL_ENTRY cli_create_fdb(char_t const* databaseName, 
...
int FASTDB_DLL_ENTRY cli_create_replication_node_fdb(int         nodeId,
                                                 int         nServers,
                                                 char*       nodeNames[],
 ...
 */
int FASTDB_DLL_ENTRY cli_close_fdb(int session);
 ...
 *     <  0 - error code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_statement_fdb(int session, char const* stmt);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_parameter_fdb(int         statement,
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_column_fdb(int         statement,
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_array_column_fdb(int            statement,
                                      char const*    column_name, 
                                      int            var_type,
                                      void*          var_ptr,
                                      cli_column_set set,
...
int FASTDB_DLL_ENTRY cli_array_column_ex_fdb(int               statement,
                                         char const*       column_name, 
                                         int               var_type,
                                         void*             var_ptr,
 ...
 *     <  0 - error code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_fetch_fdb(int statement, int for_update);
 ...
 */
int FASTDB_DLL_ENTRY cli_insert_fdb(int statement, cli_oid_t* oid);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_get_first_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_get_last_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_get_next_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_get_prev_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_skip_fdb(int statement, int n);
 ...
 *     <  0 - error code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_seek_fdb(int statement, cli_oid_t oid);
 ...
 */
cli_oid_t FASTDB_DLL_ENTRY cli_get_oid_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_update_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_remove_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_remove_current_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_free_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_close_cursor_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_commit_fdb(int session);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_precommit_fdb(int session);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_abort_fdb(int session);
 ...
 */
int FASTDB_DLL_ENTRY cli_describe_fdb(int session, char const* table, cli_field_descriptor** fields);
 ...
 *     < 0  - result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_describe_layout_fdb(int session, char const* table, cli_field_layout** fields, int* rec_size);
 ...
 */
int FASTDB_DLL_ENTRY cli_get_field_size_fdb(cli_field_descriptor* fields, int field_no);
 ...
 *     field_no - number of the field
 */
int FASTDB_DLL_ENTRY cli_get_field_offset_fdb(cli_field_descriptor* fields, int field_no);
 ...
 *     < 0  - result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_show_tables_fdb(int session, cli_table_descriptor** tables);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_create_table_fdb(int session, char const* tableName, int nFields, 
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_alter_table_fdb(int session, char const* tableName, int nFields, 
                                     cli_field_descriptor* fields);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_drop_table_fdb(int session, char const* tableName);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_alter_index_fdb(int session, char const* tableName, char const* fieldName, 
                                     int newFlags);
...
cli_error_handler FASTDB_DLL_ENTRY cli_set_error_handler_fdb(int session, cli_error_handler new_handler, void* context);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_freeze_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_unfreeze_fdb(int statement);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_attach_fdb(int session);
...
int FASTDB_DLL_ENTRY cli_detach_fdb(int session, int detach_mode);
 ...
 */
void FASTDB_DLL_ENTRY cli_free_memory_fdb(int session, void* ptr);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_get_database_state_fdb(int session, cli_database_monitor* monitor);
...
void FASTDB_DLL_ENTRY cli_set_trace_function_fdb(cli_trace_function_t func);
 ...
 *     <  0 - error code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_prepare_query_fdb(int session, char const* query);
 ...
 *     <  0 - error code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_execute_query_fdb(int statement, int for_update, void* record_struct, ...);
 ...
 *     <  0 - error code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_execute_query_ex_fdb(int statement, int for_update, void* record_struct, int n_params, int* param_types, void** param_values);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_insert_struct_fdb(int session, char const* table_name, void* record_struct, cli_oid_t* oid);
 ...
 */
 cli_transaction_context_t FASTDB_DLL_ENTRY cli_create_transaction_context_fdb();
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_join_transaction_fdb(int session, cli_transaction_context_t ctx);
 ...
 *     ctx  transaction context created by cli_create_transaction_context
 */
void FASTDB_DLL_ENTRY cli_remove_transaction_context_fdb(cli_transaction_context_t ctx);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_xml_export_fdb(int session, FILE* out);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_xml_import_fdb(int session, FILE* in);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_backup_fdb(int session, char_t const* file_name, int compactify);
 ...
 *     result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY cli_schedule_backup_fdb(int session, char_t const* file_name, int period);
 ...
 *    result code as described in cli_result_code enum
 *
 * Comment: the function checks if the database is already online
 */
int FASTDB_DLL_ENTRY put_db_online_fdb(int session, const char_t* filename);
 ...
 *    result code as described in cli_result_code enum
 */
int FASTDB_DLL_ENTRY put_db_offline_fdb(int session);
